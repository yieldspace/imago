...
- `plugin_capability`、`session_transport`、`service_supervision`、`runner_runtime` は membership / allocation / queue / capability 関係を relation-first に持ち、cross-link 用の読みやすさは helper predicate で補う
